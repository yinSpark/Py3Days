...
class WeiBoLogin(object):
    ...
    def get_username(self):
        """
            :description: 用户名获取 su: dW5kZWZpbmVg
            :return: base64编码user, 返回su
        """
    ...
    def get_json_data(self, su_value):
        """
            :returns: 可返回json对象, 根据json键值对, 获取post请求所需data
        """
        params = {
            "entry": "weibo",
    ...
    def get_password(self, servertime, nonce, pubkey):
        """
            :param:
            :return: rsa公钥加密 "加盐"password, 返回sp
        """
